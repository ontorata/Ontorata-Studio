...
3. Redirect `/callback` → **`/workspace/personal-default`** (no API key wizard)
...
- [PHASES.md](PHASES.md) — full Studio phase index
- [architecture/adr/ADR-003-auth-external-keycloak.md](architecture/adr/ADR-003-auth-external-keycloak.md) — updated for Zitadel
