...
**Context Package (Area 2 ADR-1010…1019):** Ratary `buildContext` → immutable Context Package → `assembleWorkspacePrompt` → Ontory. Remint each turn; no Studio re-retrieve/re-rank. Knowledge: [docs-ai architecture/acos](https://github.com/ontorata/docs-ai/tree/main/architecture/acos) · [wire evidence](https://github.com/ontorata/docs-ai/blob/main/products/ratary/evidence/ADR-1011-CONTEXT-PACKAGE-WIRE-2026-07-31.md).
