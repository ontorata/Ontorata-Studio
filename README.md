...
**Context Package (ADR-1010…1014 · 1016):** Organizational recall uses Ratary `buildContext` → immutable Context Package → `assembleWorkspacePrompt` → Ontory execute. Studio does **not** re-retrieve or re-rank. Confidence is advisory (`heuristic-top-relevance-v1`). Knowledge: [ADR-1010](https://github.com/ontorata/docs-ai/blob/main/architecture/acos/ADR-1010-context-manager-architecture.md) · [ADR-1011](https://github.com/ontorata/docs-ai/blob/main/architecture/acos/ADR-1011-context-assembly-strategy.md) · [ADR-1016](https://github.com/ontorata/docs-ai/blob/main/architecture/acos/ADR-1016-context-confidence-tracking.md) · [wire evidence](https://github.com/ontorata/docs-ai/blob/main/products/ratary/evidence/ADR-1011-CONTEXT-PACKAGE-WIRE-2026-07-31.md).
